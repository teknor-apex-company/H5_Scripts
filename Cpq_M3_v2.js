var Cpq_M3_v2 = /** @class */ (function () {
    function Cpq_M3_v2(scriptArgs) {
        this.controller = scriptArgs.controller;
        this.log = scriptArgs.log;
        this.scriptName = 'Cpq_M3_v2';
        this.maxRefresh = 3;
    }
    Cpq_M3_v2.Init = function (scriptArgs) {
        new Cpq_M3_v2(scriptArgs).run();
    };
    Cpq_M3_v2.prototype.run = function () {
        this.log.Info("Init Start");
        if (sessionStorage.getItem(this.scriptName)) {
            this.maxRefresh = 2;
        }
        sessionStorage.setItem(this.scriptName, '');
    ...
    Cpq_M3_v2.prototype.addDialogWindow = function (url) {
        var _this = this;
    ...
    Cpq_M3_v2.prototype.showMessageDialog = function (dialogType, header, detailedMessage, shortMessage) {
...
//# sourceMappingURL=Cpq_M3_v2.js.map