var CenPosM3_v5 = new function () {
    var category = "CenPosM3_v5";
    var _$host;
    var Child;
    var Timer;
    var debug;
    ...
    function run(params, url, controller, inFields, preData, panelHeader, inFieldsCRS435) {
        ...
        settings = {
            ...
            open: function (event, ui) {
                ...
                registerMessage(controller, inFields, preData, panelHeader, inFieldsCRS435, cenposIframe, cenposDialog);
            },
            buttons: [],
            autoFocus: true,
            width: width,
    ...
    function addPayment(inFields, preData, cenPosResponse) {
        ...
        var pmam = cenPosResponse.amount;
    ...
    function addCCRefNo(inFieldsCRS435, cenPosResponse) {
        ...
        if (window.console) {
            ...
            debug(["/m3api-rest/execute/CRCCINMI/AddCCRefNo?DIVI=", userDIVI, "&3RDP=", ScriptUtil.GetFieldValue("WW3RDP"), "&RORC=", "3", "&CCEC=", cenPosResponse.result, "&MSG1=", cenPosResponse.message, "&CCAA=", cenPosResponse.amount,
                "&CANU=", cenPosResponse.cardnumber, "&CTPY=", cenPosResponse.cardtype, "&STAT=", stat, "&REFE=", cenPosResponse.referencenumber, "&TRTY=", trty, "&CUCD=", inFieldsCRS435.currencyCode, "&3RDI=", ScriptUtil.GetFieldValue("WE3RDI"),
                "&NOCA=", cenPosResponse.nameoncard, "&ORNO=", ScriptUtil.GetFieldValue("WWORNO")].join(''));
            //            debug('PLNB: ' + plnb);
        }
        var retrieve = $.ajax({
            url: ["/m3api-rest/execute/CRCCINMI/AddCCRefNo?DIVI=", userDIVI, "&3RDP=", ScriptUtil.GetFieldValue("WW3RDP"), "&RORC=", "3", "&CCEC=", cenPosResponse.result, "&MSG1=", cenPosResponse.message, "&CCAA=", cenPosResponse.amount,
                "&CANU=", cenPosResponse.cardnumber, "&CTPY=", cenPosResponse.cardtype, "&STAT=", stat, "&REFE=", cenPosResponse.referencenumber, "&TRTY=", trty, "&CUCD=", inFieldsCRS435.currencyCode, "&3RDI=", ScriptUtil.GetFieldValue("WE3RDI"),
                "&NOCA=", cenPosResponse.nameoncard, "&ORNO=", ScriptUtil.GetFieldValue("WWORNO")].join(''),
            dataType: 'json',
        });
        retrieve.done(function (data) {
            if (hasDataFromM3(data)) {
                ...
                console.error(["Failed to get any response: /m3api-rest/execute/CRCCINMI/AddCCRefNo?DIVI=", userDIVI, "&3RDP=", ScriptUtil.GetFieldValue("WW3RDP"), "&RORC=", "3", "&CCEC=", cenPosResponse.result, "&MSG1=", cenPosResponse.message, "&CCAA=", cenPosResponse.amount,
                    "&CANU=", cenPosResponse.cardnumber, "&CTPY=", cenPosResponse.cardtype, "&STAT=", stat, "&REFE=", cenPosResponse.referencenumber, "&TRTY=", trty, "&CUCD=", inFieldsCRS435.currencyCode, "&TRDI=", ScriptUtil.GetFieldValue("WE3RDI"),
                    "&NOCA=", cenPosResponse.nameoncard, "&ORNO=", ScriptUtil.GetFieldValue("WWORNO")].join('')), data;
                deffered.fail();
            }
        });
        retrieve.fail(function (err) {
            console.error(["Failed to get any response: /m3api-rest/execute/CRCCINMI/AddCCRefNo?DIVI=", userDIVI, "&3RDP=", ScriptUtil.GetFieldValue("WW3RDP"), "&RORC=", "3", "&CCEC=", cenPosResponse.result, "&MSG1=", cenPosResponse.message, "&CCAA=", cenPosResponse.amount,
                "&CANU=", cenPosResponse.cardnumber, "&CTPY=", cenPosResponse.cardtype, "&STAT=", stat, "&REFE=", cenPosResponse.referencenumber, "&TRTY=", trty, "&CUCD=", inFieldsCRS435.currencyCode, "&TRDI=", ScriptUtil.GetFieldValue("WE3RDI"),
                "&NOCA=", cenPosResponse.nameoncard, "&ORNO=", ScriptUtil.GetFieldValue("WWORNO")].join('')), err;
            deffered.fail();
        });
        return deffered.promise();
    }
    ...
    function counter(args) {
        ...
        if (panelHeader == 'OIS215/B' || panelHeader == 'OIS215/D') {
            ...
            addCCRefNo(inFieldsCRS435, response).then(function (resp) {
                controller.PressKey("F5");
            });
        }
        if (window.console) {
    ...
    var receiveMessage = function (response, params) {
        var controller = params.controller, inFields = params.inFields, preData = params.preData, panelHeader = params.panelHeader, inFieldsCRS435 = params.inFieldsCRS435, cenposIframe = params.cenposIframe, cenposDialog = params.cenposDialog;
        counter([controller, inFields, preData, panelHeader, inFieldsCRS435, cenposIframe, cenposDialog, response]);
    };
    var registerMessage = function (controller, inFields, preData, panelHeader, inFieldsCRS435, cenposIframe, cenposDialog) {
        var messageParams = {
...
//# sourceMappingURL=CenPosM3_v5.js.map